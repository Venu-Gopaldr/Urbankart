...
import com.app.controllers.SignInSignUpController;
...
public class JWTRequestFilter extends OncePerRequestFilter {
	Logger log 
    = Logger.getLogger( 
    		OncePerRequestFilter.class.getName());
	@Autowired
...
//					Save this authentication token in the sec ctx.
					...
					log.info("user name null or authentication already set , username {}");
			
			}
		} else
			log.info("Request header DOES NOT contain a Bearer Token");
