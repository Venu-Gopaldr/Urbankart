...
INSERT INTO urbankart.categories (`id`,`categoryName`,`description`) VALUES (1,'Mobiles','Mobiles & Accessories');
INSERT INTO urbankart.categories (`id`,`categoryName`,`description`) VALUES (2,'Laptops','Laptops & Accessories');
INSERT INTO urbankart.categories(`id`,`categoryName`,`description`) VALUES (3,'TV & Appliance','TV & Home Entertainment');
...
VALUES ('admin@gmail.com', 'UBDT', 'CSE', '1234567890', '$2a$10$zPMOkBow0HyzSmvOeHVDdeL7svvmLxFgToDwFwvzOlcHJXM3f3moO', 'ADMIN');


INSERT INTO urbankart.users (email, first_name, last_name, mobile_number, password, role)
VALUES ('customer@gmail.com', 'Venu', 'gopaldr', '9876543210', '$2a$10$zPMOkBow0HyzSmvOeHVDdeL7svvmLxFgToDwFwvzOlcHJXM3f3moO', 'CUSTOMER');
